...
class Attribute extends Model
{
    ...
    protected $table = 'broker_attributes';
    ...
    {
        return \Modules\Broker\Database\factories\AttributFactory::new();
    }

    public function options()
    {
        return $this->hasMany('Modules\Broker\Entities\AttributeOption', 'attribute_id');
    }
